...
import hotel.admin.Reservations;
import hotel.admin.ReservationsForm;
 ...
 * @author 17182
 */
public class CustomerReservationForm extends javax.swing.JFrame {

    Reservations customerReservation = new Reservations();
    private int customerID;
    
    public CustomerReservationForm(int ID){
        initComponents();
        customerID = ID;
        jTableReservation.setRowHeight(25);
        customerReservation.fillCustomerReservationsJTable(jTableReservation, customerID);
        
    }
    public CustomerReservationForm() {
        initComponents();
    }
                ...
                .addGroup(jPanel2Layout.createSequentialGroup()
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jButtonClearFields, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 323, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jButtonAddReservation, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 323, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGap(15, 15, 15))
                .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void jButtonAddReservationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddReservationActionPerformed
        ...
        try{
               ...
               customerID = Integer.valueOf(jTextFieldCustomerID.getText()); 
               ...
               {
                    if(customerReservation.addReservation(customerID, roomNumber, arrivalDate, departureDate))
                    {
    ...
    private void jButtonDeleteReservationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteReservationActionPerformed
        try{
                ...
                if(customerReservation.removeReservation(reservationID))
                 {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerReservationForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerReservationForm().setVisible(true);
            }
        });
    }
